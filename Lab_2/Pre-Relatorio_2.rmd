...
### Qual é a tensão de pico inversa (PIV) suportada pelo diodo 1N4148, indicada pelo fabricante?
...
- Pesquisar como aproximar e calcular o valor de tensão pico-a-pico da ondulação (*Ripple*), em função de\
